...
echo -n '{"topic":"sorted","partition":0,"offset":0,"tstype":"create","ts":1613826868173,"broker":0,"key":"TheKey","payload":"payload1"}{"topic":"sorted","partition":0,"offset":0,"tstype":"create","ts":1613826868173,"broker":0,"key":"TheKey","payload":"payload2"}' | $KAFKACAT -P -t $topic -J
